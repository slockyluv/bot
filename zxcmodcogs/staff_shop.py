        ...
        if custom_id[:4] == "shop":
            ...
            if custom_id == "shop_back":
                ...
                if custom_id == "shop_other_accept":
                    ...
                    embed.description = f"{inter.author.mention}, **Вы успешно**, приобрели **{description}** за **{price}** {files.find_one({"_id": 'point'})['emoji_take']}",
                    ...
                    embed.description = f"{inter.author.mention}, **Вы уверены**, что Вы хотите купить **{description}** за **{price}** {files.find_one({"_id": 'point'})['emoji_take']} ?\nДля **согласия** нажмите на {files.find_one({'_id': 'accept'})['emoji_take']}, для **отказа** на {files.find_one({'_id': 'decline'})['emoji_take']}"
