...
#
    ...
    async def appeal(self, inter):
        ...
        embed = disnake.Embed(
            color=3092790,
            description=(f'# ПОЛУЧИЛ БАН? \n\n*Если вы оказались в данном канале, то это означает, что Вы серьёзно нарушили правила сервера и получили за это бан.*\n\n**Форма заполнения:**\n\n<:to4kaa:947909744985800804> Дата получения бана и кто его выдал\n<:to4kaa:947909744985800804> Причина бана, вы должны написать чёткий пункт правил\n<:to4kaa:947909744985800804> Почему по вашему мнению, вас должны разбанить?\n\nВсё это ты можешь описать в канале ⁠⁠<#1282408238955892827>\n\n*Обратите внимание, что завки на обжалование бана рассматривает администратор с ролью <@&{config['moderator_admin']}>, а заявки на обжалование недопуска рассматривает администратор с ролью <@&{config['support_admin']}>, не зависимо от ваших пожеланий или требований.*\n*Заявки, поданные со сторонних аккаунтов, рассматриваться не будут.*'
            )
        )
    ...
    async def appeal1(self, inter):
        ...
        embed = disnake.Embed(
            color=3092790,
            description=(f'# ПОЛУЧИЛ НЕДОПУСК? \n\n*Если вы оказались в данном канале, то это означает, что Вы серьёзно нарушили правила сервера и получили за это бан.*\n\n  **Форма заполнения:**\n\n<:to4kaa:947909744985800804> Дата получения бана и кто его выдал\n<:to4kaa:947909744985800804> Причина бана, вы должны написать чёткий пункт правил\n<:to4kaa:947909744985800804> Почему по вашему мнению, вас должны разбанить?\n\nВсё это ты можешь описать в канале ⁠⁠<#1282408275089817821>\n\n*Обратите внимание, что завки на обжалование бана рассматривает администратор с ролью <@&{config['moderator_admin']}>, а заявки на обжалование недопуска рассматривает администратор с ролью <@&{config['support_admin']}>, не зависимо от ваших пожеланий или требований.*\n*Заявки, поданные со сторонних аккаунтов, рассматриваться не будут.*'
            )
        )
        embed.set_footer(text="Все заявки будут рассмотрены в течение 24 часов")
        embed.set_image(url = "https://cdn.discordapp.com/attachments/1068973656228757606/1141374896258175138/line.png?ex=67979534&is=679643b4&hm=4c13a7e04014dd57bbe2648c13096014c36f79b05bef0fc50d0a135394591a45&")
